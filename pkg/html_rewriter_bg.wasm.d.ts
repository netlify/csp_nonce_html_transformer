...
export function element_setAttribute(a: number, b: number, c: number, d: number, e: number): Array;
export function __wbg_htmlrewriter_free(a: number, b: number): void;
export function htmlrewriter_new(a: number): number;
export function htmlrewriter_on(a: number, b: number, c: number, d: number): Array;
